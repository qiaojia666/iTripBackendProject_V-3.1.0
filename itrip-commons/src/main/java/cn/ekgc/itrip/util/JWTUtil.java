...
public class JWTUtil {
	...
	public static String createToken(Long userId){
		...
		// 进行加密，获得最终的JSON
		String jwtJASON = builder.sign(algorithm);
		return jwtJASON;

	}

//	public static void main(String[] args) {
//		System.out.println(createToken(250L));
//	}
	...
	public static void main(String[] args) {
		System.out.println(decryptToken("eyJ0eXBlIjoiand0IiwiYWxnIjoiSFMyNTYiLCJ0eXAiOiJKV1QifQ.eyJpZCI6MjUwfQ.7WIJJqMtER_n2O5ZkXTlXaEdLHnu5ntE2jXEHieC29U"));
	}
}
